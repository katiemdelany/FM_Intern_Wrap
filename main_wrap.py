...
def main():
	...
	if args.assemblies:
		...
		logging.info("********************************************************************************************")
		make_align_fold = "mkdir {}macsed_alignments".format(path_to_merged_alignment + "../")
		os.system("make_align_fold")
		copy_MACSE_output = "find %s -type f -name '*mask_align_NT.aln | cp -r {} %s '"%(path_to_merged_alignment, path_to_merged_alignment + "../macsed_alignments")
		copy_MACSE_output = "find %s -type f -name '*mask_align_AA.aln | cp -r {} %s '"%(path_to_merged_alignment, path_to_merged_alignment + "../macsed_alignments")
		os.system(copy_MACSE_output)
		os.system(copy_MACSE_output1)
		if args.gblocks_relaxed:
			run_gblocks("_final_mask_align_NT.aln","macsed_final_mask_align_AA.aln", path_to_merged_alignment + "../macsed_alignments")
